...
BlaBla is location-based social media service. This release intends to share a simplified version of Expo apps and Microservice architecture. This repository contains microservice for uploading thumbnail of post with Spring Cloud and Multipart. Also, Azure BLob is used for file storage and Jit is used for docker
